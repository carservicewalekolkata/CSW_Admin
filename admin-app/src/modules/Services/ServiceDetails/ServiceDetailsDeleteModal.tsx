...
type ServiceDetailsDeleteModalProps = {
  modal: ServiceDeleteModalState
}

const ServiceDetailsDeleteModal = ({ modal }: ServiceDetailsDeleteModalProps) => {
...
export default ServiceDetailsDeleteModal
