import type { BrandFiltersState } from '@/types/brandsPage'
...
const BrandsFilters = ({ filters, pageSizeOptions = DEFAULT_PAGE_SIZES }: BrandsFiltersProps) => {
  ...
  const summaryText = filters.total === 0
    ? 'Showing 0-0 of 0 brands'
    : `Showing ${filters.startIndex}-${Math.max(filters.startIndex, filters.endIndex)} of ${filters.total} brands`
